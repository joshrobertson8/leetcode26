<h1>3678 - Design Task Manager</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/design-task-manager/">design-task-manager</a></h2><p>There is a task management system that allows users to manage their tasks, each associated with a priority. The system should efficiently handle adding, modifying, executing, and removing tasks.</p>
